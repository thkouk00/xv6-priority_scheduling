...
main()
{
  ...
  10:	51                   	push   %ecx
	...
	char c[SIZE];
	fd = open("WL2", 0);
  11:	bb 40 9c 00 00       	mov    $0x9c40,%ebx
  16:	8d bd d8 d8 ff ff    	lea    -0x2728(%ebp),%edi
#include "stat.h"
#include "user.h"
#define SIZE 10000
int
main()
{
  1c:	81 ec 20 27 00 00    	sub    $0x2720,%esp
	int i,fd;
	int counter=0;
	long temp=0,temp1=0,temp2=2;
	char c[SIZE];
	fd = open("WL2", 0);
  22:	6a 00                	push   $0x0
  24:	68 90 07 00 00       	push   $0x790
  29:	e8 34 03 00 00       	call   362 <open>
  ...
  35:	8d 76 00             	lea    0x0(%esi),%esi
		...
		temp1++;
		(int)c[1]++;
  38:	80 85 d9 d8 ff ff 01 	addb   $0x1,-0x2727(%ebp)
	int i,fd;
	int counter=0;
	long temp=0,temp1=0,temp2=2;
	char c[SIZE];
  ...
  4c:	57                   	push   %edi
  4d:	56                   	push   %esi
  4e:	e8 e7 02 00 00       	call   33a <read>
  53:	83 c4 10             	add    $0x10,%esp
  56:	3d 0f 27 00 00       	cmp    $0x270f,%eax
  5b:	7f db                	jg     38 <main+0x38>
		{
			close(fd);
  5d:	83 ec 0c             	sub    $0xc,%esp
  60:	56                   	push   %esi
  61:	e8 e4 02 00 00       	call   34a <close>
			fd = open("WL2", 0);
  66:	58                   	pop    %eax
  67:	5a                   	pop    %edx
  68:	6a 00                	push   $0x0
  6a:	68 90 07 00 00       	push   $0x790
  6f:	e8 ee 02 00 00       	call   362 <open>
  74:	83 c4 10             	add    $0x10,%esp
		...
		temp1++;
		(int)c[1]++;
  77:	80 85 d9 d8 ff ff 01 	addb   $0x1,-0x2727(%ebp)
	int i,fd;
	int counter=0;
	long temp=0,temp1=0,temp2=2;
	char c[SIZE];
  ...
  85:	0f be 95 dc d8 ff ff 	movsbl -0x2724(%ebp),%edx
		temp = temp + 2*temp1 - 2*i;
		temp2= temp1*temp + temp1;
		temp2= temp1*temp + temp1;
  8c:	b8 89 1a 3e a4       	mov    $0xa43e1a89,%eax
		temp1++;
		(int)c[1]++;
		temp1 = temp+temp2;
		temp=5*i +i;
		temp1 = temp*temp + i;
		temp = temp + 2*temp1 - 2*(int)c[4];
  91:	01 d2                	add    %edx,%edx
		temp = temp + 2*temp1 - 2*i;
		temp2= temp1*temp + temp1;
		temp2= temp1*temp + temp1;
  93:	29 d0                	sub    %edx,%eax
  95:	69 c0 63 ea 0e 69    	imul   $0x690eea63,%eax,%eax
		temp = temp2 + temp2;
		temp = (2*temp1+temp2)*temp2;
  9b:	8d 90 c6 d4 1d d2    	lea    -0x2de22b3a(%eax),%edx
  a1:	0f af c2             	imul   %edx,%eax
		temp = temp + 2*temp1 - 2*i;
		temp = temp + 2*temp1 - 2*i;
		temp2= temp1*temp + temp1;
  ...
  a4:	0f be 95 da d8 ff ff 	movsbl -0x2726(%ebp),%edx
  ab:	52                   	push   %edx
  ac:	8d 90 95 38 39 a4    	lea    -0x5bc6c76b(%eax),%edx
  b2:	69 d2 64 ea 0e 69    	imul   $0x690eea64,%edx,%edx
  b8:	29 c2                	sub    %eax,%edx
  ba:	89 d0                	mov    %edx,%eax
  bc:	2d f8 22 48 0d       	sub    $0xd4822f8,%eax
  c1:	50                   	push   %eax
  c2:	68 94 07 00 00       	push   $0x794
  c7:	6a 01                	push   $0x1
  c9:	e8 a2 03 00 00       	call   470 <printf>
	close(fd);
  ce:	89 34 24             	mov    %esi,(%esp)
  d1:	e8 74 02 00 00       	call   34a <close>
	exit();
  d6:	e8 47 02 00 00       	call   322 <exit>
  db:	66 90                	xchg   %ax,%ax
  dd:	66 90                	xchg   %ax,%ax
  df:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40f:	f7 f6                	div    %esi
 411:	0f b6 92 ac 07 00 00 	movzbl 0x7ac(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 448:	e8 f5 fe ff ff       	call   342 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 4b8:	50                   	push   %eax
 4b9:	57                   	push   %edi
 4ba:	e8 83 fe ff ff       	call   342 <write>
...
putc(int fd, char c)
{
 ...
 51a:	50                   	push   %eax
 51b:	57                   	push   %edi
 51c:	e8 21 fe ff ff       	call   342 <write>
...
putc(int fd, char c)
{
 ...
 588:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 58b:	b8 a3 07 00 00       	mov    $0x7a3,%eax
...
putc(int fd, char c)
{
 ...
 5ae:	50                   	push   %eax
 5af:	57                   	push   %edi
 5b0:	e8 8d fd ff ff       	call   342 <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 5ff:	50                   	push   %eax
 600:	57                   	push   %edi
 601:	e8 3c fd ff ff       	call   342 <write>
...
free(void *ap)
{
 ...
 611:	a1 50 0a 00 00       	mov    0xa50,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 68a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 68d:	a3 50 0a 00 00       	mov    %eax,0xa50
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 50 0a 00 00    	mov    0xa50,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6ff:	76 3f                	jbe    740 <malloc+0xa0>
    ...
    if(p == freep)
 701:	39 05 50 0a 00 00    	cmp    %eax,0xa50
 ...
 70e:	53                   	push   %ebx
 70f:	e8 96 fc ff ff       	call   3aa <sbrk>
  if(p == (char*)-1)
 ...
 726:	e8 e5 fe ff ff       	call   610 <free>
  return freep;
 72b:	8b 15 50 0a 00 00    	mov    0xa50,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 74c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 74f:	89 15 50 0a 00 00    	mov    %edx,0xa50
      return (void*)(p + 1);
 ...
 764:	eb e9                	jmp    74f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 766:	c7 05 50 0a 00 00 54 	movl   $0xa54,0xa50
 76d:	0a 00 00 
 770:	c7 05 54 0a 00 00 54 	movl   $0xa54,0xa54
 777:	0a 00 00 
    base.s.size = 0;
 77a:	b8 54 0a 00 00       	mov    $0xa54,%eax
 77f:	c7 05 58 0a 00 00 00 	movl   $0x0,0xa58
 786:	00 00 00 
