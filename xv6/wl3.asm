...
main()
{
  ...
  10:	51                   	push   %ecx
	...
	char c[SIZE];
	fd = open("WL2", 0);
  11:	bb 90 5f 01 00       	mov    $0x15f90,%ebx
...
main()
{
  1c:	81 ec 20 27 00 00    	sub    $0x2720,%esp
	...
	fd = open("WL2", 0);
  22:	6a 00                	push   $0x0
  24:	68 50 07 00 00       	push   $0x750
  29:	e8 f4 02 00 00       	call   322 <open>
  ...
  3b:	74 3a                	je     77 <main+0x77>
	{

		if ((counter = read(fd, c, SIZE)) < SIZE) 
  3d:	83 ec 04             	sub    $0x4,%esp
  40:	68 10 27 00 00       	push   $0x2710
  45:	57                   	push   %edi
  46:	56                   	push   %esi
  47:	e8 ae 02 00 00       	call   2fa <read>
  4c:	83 c4 10             	add    $0x10,%esp
  4f:	3d 0f 27 00 00       	cmp    $0x270f,%eax
  54:	7f e2                	jg     38 <main+0x38>
		{
			close(fd);
  56:	83 ec 0c             	sub    $0xc,%esp
  59:	56                   	push   %esi
  5a:	e8 ab 02 00 00       	call   30a <close>
			fd = open("WL2", 0);
  5f:	58                   	pop    %eax
  60:	5a                   	pop    %edx
  61:	6a 00                	push   $0x0
  63:	68 50 07 00 00       	push   $0x750
  68:	e8 b5 02 00 00       	call   322 <open>
  ...
  75:	75 c6                	jne    3d <main+0x3d>
	...
	printf (1,"END WL3 %c\n",c[0]);
  77:	0f be 85 d8 d8 ff ff 	movsbl -0x2728(%ebp),%eax
  ...
  91:	e8 74 02 00 00       	call   30a <close>
	exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cf:	f7 f6                	div    %esi
 3d1:	0f b6 92 68 07 00 00 	movzbl 0x768(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 60 07 00 00       	mov    $0x760,%eax
