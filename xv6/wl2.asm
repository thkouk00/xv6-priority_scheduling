...
main()
{
   ...
   f:	53                   	push   %ebx
  10:	51                   	push   %ecx
  11:	8d 7d e7             	lea    -0x19(%ebp),%edi
	int fd;
	int i;
	char c[1];
	fd = open("WL2", 0);
  14:	bb 40 42 0f 00       	mov    $0xf4240,%ebx
#include "stat.h"
#include "user.h"
...
main()
{
  19:	83 ec 20             	sub    $0x20,%esp
	int fd;
	int i;
	char c[1];
	fd = open("WL2", 0);
  1c:	6a 00                	push   $0x0
  1e:	68 20 07 00 00       	push   $0x720
  23:	e8 ca 02 00 00       	call   2f2 <open>
  ...
  35:	57                   	push   %edi
  36:	56                   	push   %esi
  37:	e8 8e 02 00 00       	call   2ca <read>
{
	int fd;
	int i;
	char c[1];
  ...
  47:	56                   	push   %esi
  48:	e8 8d 02 00 00       	call   2da <close>
	printf(1,"END W2 %c\n",c[0]);
  4d:	0f be 45 e7          	movsbl -0x19(%ebp),%eax
  51:	83 c4 0c             	add    $0xc,%esp
  54:	50                   	push   %eax
  55:	68 24 07 00 00       	push   $0x724
  5a:	6a 01                	push   $0x1
  5c:	e8 9f 03 00 00       	call   400 <printf>
	exit();
  61:	e8 4c 02 00 00       	call   2b2 <exit>
  66:	66 90                	xchg   %ax,%ax
  68:	66 90                	xchg   %ax,%ax
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39f:	f7 f6                	div    %esi
 3a1:	0f b6 92 38 07 00 00 	movzbl 0x738(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 2f 07 00 00       	mov    $0x72f,%eax
...
free(void *ap)
{
 ...
 5a1:	a1 dc 09 00 00       	mov    0x9dc,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5f9:	a3 dc 09 00 00       	mov    %eax,0x9dc
}
 5fe:	5b                   	pop    %ebx
 5ff:	5e                   	pop    %esi
 600:	5f                   	pop    %edi
 ...
 61a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 61d:	a3 dc 09 00 00       	mov    %eax,0x9dc
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 dc 09 00 00    	mov    0x9dc,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 68f:	76 3f                	jbe    6d0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	39 05 dc 09 00 00    	cmp    %eax,0x9dc
 ...
 6b6:	e8 e5 fe ff ff       	call   5a0 <free>
  return freep;
 6bb:	8b 15 dc 09 00 00    	mov    0x9dc,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6df:	89 15 dc 09 00 00    	mov    %edx,0x9dc
      return (void*)(p + 1);
 ...
 6f4:	eb e9                	jmp    6df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6f6:	c7 05 dc 09 00 00 e0 	movl   $0x9e0,0x9dc
 6fd:	09 00 00 
 700:	c7 05 e0 09 00 00 e0 	movl   $0x9e0,0x9e0
 707:	09 00 00 
    base.s.size = 0;
 70a:	b8 e0 09 00 00       	mov    $0x9e0,%eax
 70f:	c7 05 e4 09 00 00 00 	movl   $0x0,0x9e4
 716:	00 00 00 
