...
main()
{
  ...
  11:	8d 7d e7             	lea    -0x19(%ebp),%edi
	...
	char c[1];
	fd = open("WL2", 0);
  14:	bb 20 a1 07 00       	mov    $0x7a120,%ebx
#include "stat.h"
#include "user.h"
...
main()
{
  ...
  37:	e8 8e 02 00 00       	call   2ca <read>
		...
		temp1++;
		(int)c[0]++;
  3c:	80 45 e7 01          	addb   $0x1,-0x19(%ebp)
	int fd;
	int i;
	long temp=0, temp1=0,temp2=1; 
	char c[1];
  ...
  48:	57                   	push   %edi
  49:	68 f4 6f d4 cb       	push   $0xcbd46ff4
  4e:	68 24 07 00 00       	push   $0x724
  53:	6a 01                	push   $0x1
  55:	e8 a6 03 00 00       	call   400 <printf>
	close(fd);
  5a:	89 34 24             	mov    %esi,(%esp)
  5d:	e8 78 02 00 00       	call   2da <close>
	exit();
  62:	e8 4b 02 00 00       	call   2b2 <exit>
  67:	66 90                	xchg   %ax,%ax
  69:	66 90                	xchg   %ax,%ax
  6b:	66 90                	xchg   %ax,%ax
  6d:	66 90                	xchg   %ax,%ax
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 33 07 00 00       	mov    $0x733,%eax
